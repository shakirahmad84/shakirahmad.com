    ...
    navbarColor: function() {
        ...
        $(window).on('scroll', function() {
            if ($(this).scrollTop() > 70) { // Set position from top to add class
                ...
                $('.pink .navbar-brand> img').attr('src', 'assets/img/logo/logo-blue-dark.png');
                $('.white .navbar-brand> img').attr('src', 'assets/img/logo/logo-blue-white.png');
                // $('.side_button_3').addClass('position_fixed');
            } else {
                $('.navbar').removeClass("shrink");
                $('.pink .navbar-brand> img').attr('src', 'assets/img/logo/logo-blue-white.png');
                $('.white .navbar-brand> img').attr('src', 'assets/img/logo/logo-blue-white.png');
                $('.index9 .navbar-brand> img').attr('src', 'assets/img/logo/logo-blue-dark.png');
